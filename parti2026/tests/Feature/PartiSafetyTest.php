...
class PartiSafetyTest extends TestCase
{
    ...
    public function test_gform_link_validation_rejects_phishing_attempts(): void
    {
        ...
        $validator1 = Validator::make(
            ['gform_link' => 'https://docs.google.com/forms/d/e/1FAIpQLSfXYZ/viewform'],
            $rules
        );
        ...
        $validator2 = Validator::make(
            ['gform_link' => 'https://forms.gle/xyz123abc'],
            $rules
        );
        ...
        $validator3 = Validator::make(
            ['gform_link' => 'https://phishing-site.com/redirect?to=docs.google.com/forms/xyz'],
            $rules
        );
