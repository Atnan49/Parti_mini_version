...
<div class="max-w-2xl mx-auto space-y-6 text-left">
    ...
    <div class="bg-white border border-line rounded-[6px] p-6 md:p-8 shadow-sm">
        <form method="POST" action="{{ route('admin.sponsors.update', $sponsor->id) }}" enctype="multipart/form-data" class="space-y-6">
            ...
            <!-- Name -->
            <div>
                <label for="name" class="block font-mono text-[11px] tracking-wider uppercase text-ink-soft mb-1.5 font-bold font-bold">Nama Perusahaan / Sponsor</label>
            ...
            <!-- Website URL -->
            <div>
                <label for="website_url" class="block font-mono text-[11px] tracking-wider uppercase text-ink-soft mb-1.5 font-bold font-bold">Link Website (Opsional)</label>
