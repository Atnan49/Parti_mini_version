                ...
                <tbody class="divide-y divide-line/40 text-sm">
                    @forelse($sponsors as $sponsor)
                        <tr class="hover:bg-paper-warm/10 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                <span class="inline-block px-2.5 py-0.5 rounded-[3px] text-[10px] font-mono font-bold uppercase border
                                    @if($sponsor->tier === 'PLATINUM') bg-emerald-50 text-emerald-700 border-emerald-200
                                    @elseif($sponsor->tier === 'GOLD') bg-amber-50 text-amber-700 border-amber-200
                                    @elseif($sponsor->tier === 'SILVER') bg-slate-50 text-slate-700 border-slate-200
                            ...
                            <td class="px-6 py-4 text-center">
                                <span class="inline-block px-2 py-0.5 rounded-[3px] text-[10px] font-mono font-bold uppercase border
                                    @if($sponsor->is_active) bg-emerald-50 text-emerald-700 border-emerald-200
