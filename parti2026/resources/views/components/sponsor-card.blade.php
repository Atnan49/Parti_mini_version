    ...
    <{{ $hasUrl ? 'a' : 'div' }}
        ...
        @if($hasValidLogo)
            <img src="{{ $sponsor->logo_url }}" 
                 ...
                 class="{{ $imgClasses[$size] }} w-auto max-w-[100px] sm:max-w-[140px] object-contain transition-all duration-300 filter-gpu dark:invert dark:hue-rotate-180 dark:brightness-150">
        @else
